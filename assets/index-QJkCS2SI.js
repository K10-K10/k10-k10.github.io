...
`,at={"/src/contents/tuilib/README.md":le,"/src/contents/tuilib/docs/changelog/0.1.0.md":fe,"/src/contents/tuilib/docs/changelog/0.2.0.md":me,"/src/contents/tuilib/docs/changelog/0.3.0.md":ge,"/src/contents/tuilib/docs/changelog.md":ve,"/src/contents/tuilib/docs/dev/file_dependency.md":be,"/src/contents/tuilib/docs/dialy.md":Se,"/src/contents/tuilib/docs/examples.md":we,"/src/contents/tuilib/docs/getting_started.md":Ee,"/src/contents/tuilib/docs/points.md":Oe,"/src/contents/tuilib/docs/references/app.md":Ae,"/src/contents/tuilib/docs/references/events/keyevent.md":Me,"/src/contents/tuilib/docs/references/events.md":Pe,"/src/contents/tuilib/docs/references/layout/rect.md":Ie,"/src/contents/tuilib/docs/references/layout.md":Re,"/src/contents/tuilib/docs/references/object/block.md":Be,"/src/contents/tuilib/docs/references/object/list.md":He,"/src/contents/tuilib/docs/references/object/textfield.md":We,"/src/contents/tuilib/docs/references/objects.md":Ke,"/src/contents/tuilib/docs/references/style/style.md":Je,"/src/contents/tuilib/docs/references/text/text.md":Xe,"/src/contents/tuilib/docs/references.md":X,"/src/contents/tuilib/docs/sample/colour_palette.md":$e,"/src/contents/tuilib/docs/sample/counter.md":tt,"/src/contents/tuilib/docs/samples.md":rt},Z=e=>typeof e==`string`?e.toLowerCase().trim().replace(/\s+/g,`-`).replace(/\./g,`-`).replace(/\(\)/g,``):Array.isArray(e)?e.map(e=>Z(e)).join(``):e&&typeof e==`object`&&`props`in e?Z(e.props.children):``,ot=e=>{let t={title:``,version:``,date:``,namespace:``},n=e;if(e&&e.startsWith(`---`)){let r=e.split(`---`);r.length>=3&&(n=r.slice(2).join(`---`).trim(),r[1].split(`
`).forEach(e=>{let[n,...r]=e.split(`:`);if(n&&r.length>0){let e=n.trim();t[e]=r.join(`:`).trim().replace(/['"]/g,``)}}))}return{data:t,bodyContent:n}};function st(){let{"*":e}=a(),t=`/src/contents/tuilib/${e}.md`.replace(/\/+/g,`/`),n=at[t];if(!n)return d(`div`,{style:{padding:`20px`,color:`#ff4d4f`},children:d(`h2`,{children:`Document not found.`})});let r=n,i=typeof r.default==`string`?r.default:``,{data:o,bodyContent:l}=ot(i),u=o.title,f=o.version,h=o.date,g=o.namespace;return m(`div`,{className:`TuiDocs-main`,children:[d(x,{title:u?`K10-K10 - ${u}`:`K10-K10 - TUI Docs`,linkTitle:`tui`,description:`K10-K10 Documentation - TUI library in C++ documentation.`,pageUrl:`https://K10-K10.github.io/docs/tuilib/${e}`}),m(`div`,{style:{display:`flex`,gap:`20px`,alignItems:`flex-start`,width:`100%`},children:[d(q,{}),d(A,{title:u||`Documentation`,style:{flex:1},children:m(`article`,{className:`tui-post-container`,style:{maxWidth:`800px`,margin:`0 auto`},children:[(f||h||g)&&m(`div`,{style:{marginBottom:`20px`,padding:`10px 15px`,background:`rgba(0,0,0,0.03)`,borderRadius:`6px`,fontSize:`0.9rem`,color:`#555`,display:`flex`,gap:`20px`,flexWrap:`wrap`},children:[f&&m(`span`,{children:[d(`strong`,{children:`Version:`}),` `,f]}),h&&m(`span`,{children:[d(`strong`,{children:`Date:`}),` `,h]}),g&&m(`span`,{children:[d(`strong`,{children:`Namespace:`}),` `,d(`code`,{children:g})]})]}),d(s,{remarkPlugins:[p],components:{code({node:e,className:t,children:n,...r}){let i=/language-(\w+)/.exec(t||``),a=i?i[1]:`text`,o=!t&&!String(n).includes(`
`);return d(B,{lang:a,inline:o,children:n})},a({href:e,children:t,...n}){if(!e)return null;if(e.startsWith(`http`)||e.startsWith(`#`))return d(`a`,{href:e,target:e.startsWith(`http`)?`_blank`:void 0,rel:`noreferrer`,...n,children:t});let r=()=>{setTimeout(()=>{window.scrollTo(0,0);let e=document.querySelector(`.TuiDocs-main`);e&&(e.scrollTop=0)},50)},i=e.replace(/^\.\.\//,``).replace(/^\.\//,``).replace(/\.md$/,``),a=location.pathname.split(`/`);a.pop();let o=`${a.join(`/`)}/${i}`.replace(/\/+/g,`/`);return d(c,{to:o,onClick:r,...n,children:t})},h2({children:e,...t}){let n=Z(e);return d(`h2`,{id:n,...t,children:e})},h3({children:e,...t}){let n=Z(e);return d(`h3`,{id:n,...t,children:e})},h4({children:e,...t}){let n=Z(e);return d(`h4`,{id:n,...t,children:e})},img({src:e,alt:t,...n}){if(!e||e.startsWith(`http`)||e.startsWith(`data:`))return d(`img`,{src:e,alt:t,style:{maxWidth:`100%`,height:`auto`,borderRadius:`8px`},...n});let r=`/tuilib/docs/${e.replace(/^\.\.\//,``).replace(/^\.\//,``).replace(/^docs\//i,``)}`;return r=r.replace(/\/+/g,`/`),m(`span`,{style:{display:`block`,textAlign:`center`,margin:`20px 0`},children:[d(`img`,{src:r,alt:t,style:{maxWidth:`100%`,height:`auto`,borderRadius:`8px`,boxShadow:`0 4px 12px rgba(0,0,0,0.1)`},...n}),t&&d(`span`,{style:{display:`block`,fontSize:`0.85rem`,color:`#888`,marginTop:`8px`},children:t})]})}},children:l})]})})]})]})}var Q=sessionStorage.getItem(`redirect`);Q&&(sessionStorage.removeItem(`redirect`),window.history.replaceState(null,``,Q));var ct=[{path:`/`,element:d(te,{})},{path:`/about`,element:d(j,{})},{path:`/blog`,element:d(M,{})},{path:`/blog/:headName`,element:d(N,{})},{path:`/docs`,element:d(L,{})},{path:`/docs/tuilib`,children:[{path:``,element:d(de,{})},{path:`*`,element:d(st,{})}]},{path:`/tools`,children:[{path:``,element:d(F,{})},{path:`rgb`,element:d(ne,{})},{path:`github`,element:d(se,{})},{path:`ants`,element:d(O,{})}]},{path:`*`,element:d(C,{})}];function lt(){let e=f(ct);return m(`div`,{id:`app-layout`,children:[d(x,{title:`K10-K10 - Home`,linkTitle:`Home`,description:`K10-K10 - Personal portfolio, projects, tools, and blog. Explore software development work and creative projects.`,pageUrl:`https://K10-K10.github.io/`}),d(ee,{}),d(`main`,{children:e}),d(b,{})]})}function ut(){return d(r,{basename:`/`,children:d(lt,{})})}var $=document.getElementById(`root`);if(!$)throw Error(`Root element not found`);(0,_.createRoot)($).render(d(v.StrictMode,{children:d(ut,{})}));