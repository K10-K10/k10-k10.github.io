...
**version**: _0.2.0_ | **author**: _K10-K10_ | **update**: 11/06/2026
`,Me=e({default:()=>Ne}),Ne=`# File dependency diagram
...
`,X={"/src/contents/tuilib/README.md":K,"/src/contents/tuilib/docs/api_docs/app.md":ce,"/src/contents/tuilib/docs/api_docs/block.md":ue,"/src/contents/tuilib/docs/api_docs/colour.md":fe,"/src/contents/tuilib/docs/api_docs/events.md":me,"/src/contents/tuilib/docs/api_docs/keyevent.md":ge,"/src/contents/tuilib/docs/api_docs/layout.md":ve,"/src/contents/tuilib/docs/api_docs/list.md":be,"/src/contents/tuilib/docs/api_docs/objects.md":Se,"/src/contents/tuilib/docs/api_docs/rect.md":we,"/src/contents/tuilib/docs/api_docs/text.md":Ee,"/src/contents/tuilib/docs/api_docs/textfield.md":Oe,"/src/contents/tuilib/docs/api_reference.md":Ae,"/src/contents/tuilib/docs/dev/file_dependency.md":Me,"/src/contents/tuilib/docs/dialy.md":Pe,"/src/contents/tuilib/docs/examples.md":Ie,"/src/contents/tuilib/docs/getting_started.md":Re,"/src/contents/tuilib/docs/points.md":Be,"/src/contents/tuilib/docs/references/app.md":He,"/src/contents/tuilib/docs/references/events/keyevent.md":We,"/src/contents/tuilib/docs/references/events.md":Ke,"/src/contents/tuilib/docs/references/layout/rect.md":Je,"/src/contents/tuilib/docs/references/layout.md":Xe,"/src/contents/tuilib/docs/references/object/block.md":Qe,"/src/contents/tuilib/docs/references/object/list.md":et,"/src/contents/tuilib/docs/references/object/textfield.md":nt,"/src/contents/tuilib/docs/references/objects.md":it,"/src/contents/tuilib/docs/references/style/style.md":ot,"/src/contents/tuilib/docs/references/text/text.md":ct,"/src/contents/tuilib/docs/references.md":ut,"/src/contents/tuilib/docs/sample/colour_palette.md":ft,"/src/contents/tuilib/docs/sample/counter.md":mt,"/src/contents/tuilib/docs/samples.md":gt},Z=e=>typeof e==`string`?e.toLowerCase().trim().replace(/\s+/g,`-`).replace(/\./g,`-`).replace(/\(\)/g,``):Array.isArray(e)?e.map(e=>Z(e)).join(``):e&&typeof e==`object`&&`props`in e?Z(e.props.children):``;function _t(){let{"*":e}=i(),t=`/src/contents/tuilib/${e}.md`.replace(/\/+/g,`/`),n=X[t];if(!n)return p(`div`,{style:{padding:`20px`,color:`#ff4d4f`},children:[u(`h2`,{children:`Document not found.`}),p(`p`,{children:[`探したパス (Searched): `,u(`code`,{children:t})]}),u(`p`,{children:`Viteが認識しているパス一覧 (Available):`}),u(`pre`,{children:Object.keys(X).join(`
`)})]});let r=n,a=typeof r.default==`string`?r.default:``,c=a,l=``;if(a&&a.startsWith(`---`)){let e=a.split(`---`);e.length>=3&&(c=e.slice(2).join(`---`).trim(),(e[1]?.split(`
`)||[]).forEach(e=>{let[t,...n]=e.split(`:`);t&&t.trim()===`title`&&n.length>0&&(l=n.join(`:`).trim().replace(/['"]/g,``))}))}return p(`div`,{className:`TuiDocs-main`,children:[u(x,{title:l?`K10-K10 - ${l}`:`K10-K10 - TUI Docs`,linkTitle:`tui`,description:`K10-K10 Documentation - TUI library in C++ documentation.`,pageUrl:`https://K10-K10.github.io/docs/tuilib/${e}`}),u(j,{title:l||`Documentation`,children:u(`article`,{className:`tui-post-container`,style:{maxWidth:`800px`,margin:`0 auto`},children:u(o,{remarkPlugins:[f],components:{code({node:e,className:t,children:n,...r}){let i=/language-(\w+)/.exec(t||``),a=i?i[1]:`text`,o=!t&&!String(n).includes(`
`);return u(V,{lang:a,inline:o,children:n})},a({href:e,children:t,...n}){if(!e)return null;if(e.startsWith(`http`)||e.startsWith(`#`))return u(`a`,{href:e,target:e.startsWith(`http`)?`_blank`:void 0,rel:`noreferrer`,...n,children:t});let r=()=>{setTimeout(()=>{window.scrollTo(0,0);let e=document.querySelector(`.TuiDocs-main`);e&&(e.scrollTop=0)},50)},i=e.replace(/^\.\.\//,``).replace(/^\.\//,``).replace(/\.md$/,``),a=location.pathname.split(`/`);a.pop();let o=`${a.join(`/`)}/${i}`.replace(/\/+/g,`/`);return u(s,{to:o,onClick:r,...n,children:t})},h2({children:e,...t}){let n=Z(e);return u(`h2`,{id:n,...t,children:e})},h3({children:e,...t}){let n=Z(e);return u(`h3`,{id:n,...t,children:e})},h4({children:e,...t}){let n=Z(e);return u(`h4`,{id:n,...t,children:e})},img({src:e,alt:t,...n}){if(!e||e.startsWith(`http`)||e.startsWith(`data:`))return u(`img`,{src:e,alt:t,style:{maxWidth:`100%`,height:`auto`,borderRadius:`8px`},...n});let r=`/tuilib/docs/${e.replace(/^\.\.\//,``).replace(/^\.\//,``).replace(/^docs\//i,``)}`;return r=r.replace(/\/+/g,`/`),p(`span`,{style:{display:`block`,textAlign:`center`,margin:`20px 0`},children:[u(`img`,{src:r,alt:t,style:{maxWidth:`100%`,height:`auto`,borderRadius:`8px`,boxShadow:`0 4px 12px rgba(0,0,0,0.1)`},...n}),t&&u(`span`,{style:{display:`block`,fontSize:`0.85rem`,color:`#888`,marginTop:`8px`},children:t})]})}},children:c})})})]})}var Q=sessionStorage.getItem(`redirect`);Q&&(sessionStorage.removeItem(`redirect`),window.history.replaceState(null,``,Q));var vt=[{path:`/`,element:u(C,{})},{path:`/about`,element:u(M,{})},{path:`/blog`,element:u(N,{})},{path:`/blog/:headName`,element:u(P,{})},{path:`/docs`,element:u(R,{})},{path:`/docs/tuilib`,children:[{path:``,element:u(se,{})},{path:`*`,element:u(_t,{})}]},{path:`/tools`,children:[{path:``,element:u(I,{})},{path:`rgb`,element:u(te,{})},{path:`github`,element:u(oe,{})},{path:`ants`,element:u(k,{})}]},{path:`*`,element:u(w,{})}];function yt(){let e=a(vt);return p(`div`,{id:`app-layout`,children:[u(x,{title:`K10-K10 - Home`,linkTitle:`Home`,description:`K10-K10 - Personal portfolio, projects, tools, and blog. Explore software development work and creative projects.`,pageUrl:`https://K10-K10.github.io/`}),u(y,{}),u(`main`,{children:e}),u(b,{})]})}function bt(){return u(r,{basename:`/`,children:u(yt,{})})}var $=document.getElementById(`root`);if(!$)throw Error(`Root element not found`);(0,g.createRoot)($).render(u(_.StrictMode,{children:u(bt,{})}));