  ...
  return (
    <div className="about">
      ...
      <Talk title="About the site" style_scope={{ background: "var(--cloudy_background-color)" }}>
        ...
        <a href="https://github.com/K10-K10/k10-k10.github.io">This site's source code</a>
      </Talk>
      <Talk title="About the Author">
        ...
        <p>
          Recently, I haven't been able to join in competitions. Therefore, I want to join as much
          as possible.
        </p>
        <Spacer />
