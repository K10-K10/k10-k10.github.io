	...
	return (
		<div className="about">
			...
			<Talk
				...
				style_scope={{ background: "var(--cloudy_background-color)" }}
			>
			...
			<Talk title="About the Author">
				...
				<p>
					I started programming in first grade and attended robotics classes.
				</p>
				<p>
					At the same time, my father recommended Unity, and I started learning
					C#
				</p>
				<p>
					I entered junior high school and started competitive programming and
					C++.
				</p>
				<p>
					Recently, I haven't been able to join in competitions. Therefore, I
					want to join as much as possible.
				</p>
				<Spacer />
